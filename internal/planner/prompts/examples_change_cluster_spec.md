...
```json
{
  ...
  "steps": [
    {"id":"e0","action":"EnsureNode","params":{"namespace":"example","pod":"redis-0","image":"redis:7.2","memorySize":"1Gi"}},
    {"id":"e1","action":"EnsureNode","params":{"namespace":"example","pod":"redis-1","image":"redis:7.2","memorySize":"1Gi"}},
    {"id":"e2","action":"EnsureNode","params":{"namespace":"example","pod":"redis-2","image":"redis:7.2","memorySize":"1Gi"}},
    {"id":"e3","action":"EnsureNode","params":{"namespace":"example","pod":"redis-3","image":"redis:7.2","memorySize":"1Gi"}},
    {"id":"e4","action":"EnsureNode","params":{"namespace":"example","pod":"redis-4","image":"redis:7.2","memorySize":"1Gi"}},
    {"id":"e5","action":"EnsureNode","params":{"namespace":"example","pod":"redis-5","image":"redis:7.2","memorySize":"1Gi"}},
...
### Example 2 - Replica scale-out (observed: 3 shards x 1 replica -> desired: 3 shards x 2 replicas, nextPodOrdinal=6)
...
```json
{
  ...
  "steps": [
    {"id":"e6","action":"EnsureNode","params":{"namespace":"example","pod":"redis-6","image":"redis:7.2","memorySize":"1Gi"}},
    {"id":"e7","action":"EnsureNode","params":{"namespace":"example","pod":"redis-7","image":"redis:7.2","memorySize":"1Gi"}},
    {"id":"e8","action":"EnsureNode","params":{"namespace":"example","pod":"redis-8","image":"redis:7.2","memorySize":"1Gi"}},
...
### Example 3 - Shard scale-out (observed: 3 shards x 1 replica -> desired: 4 shards x 1 replica, nextPodOrdinal=6)
